...
export const systemSettings = pgTable('SystemSettings', {
  ...
  brandLogoPngUrl: text('brandLogoPngUrl'),
  brandLogo144Url: text('brandLogo144Url'),
  brandLogoSvgUrl: text('brandLogoSvgUrl'),
  ...
  smsProvider: text('smsProvider').default('aliyun'),
  smsAliyunAccessKeyId: text('smsAliyunAccessKeyId'),
  smsAliyunAccessKeySecret: text('smsAliyunAccessKeySecret'),
